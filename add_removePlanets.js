...
var stationArry = [];
	...
	function addPlanet(){
		...
		var newPlanetInput = "<div class='new_planet"+newPlanetNum+"'><input type='text' id='new_planet"+ newPlanetNum +"' style='margin:10px;' placeholder='Planet Name'><input type='text'id='planetXCoord_"+ newPlanetNum +"'style='margin:5px;' size='10' placeholder='X-Coordinate'><input type='text'id='planetYCoord_"+ newPlanetNum +"'style='margin:5px;'size='10' placeholder='Y-Coordinate'><a href='#' id='"+ newPlanetNum +"' onclick='savePlanet(this.id)'>Save</a><a href='#' id='"+ newPlanetNum +"' onclick='removePlanet(this.id)'>Remove</a></div>";
	...
	function removePlanet(id) {
  	...
  	function addAsteroid(){
		...
		var newAsteroidInput = "<div class='new_asteroid"+newAsteroidNum+"'><input type='text' id='new_asteroid"+ newAsteroidNum +"' style='margin:10px;' value='Asteroid "+newAsteroidNum+"'><input type='text'id='asteroidXCoord_"+ newAsteroidNum +"'style='margin:5px;' size='10' placeholder='X-Coordinate'><input type='text'id='asteroidYCoord_"+ newAsteroidNum +"'style='margin:5px;'size='10' placeholder='Y-Coordinate'><a href='#' id='"+ newAsteroidNum +"' onclick='saveAsteroid(this.id)'>Save</a><a href='#' id='"+ newAsteroidNum +"' onclick='removeAsteroid(this.id)'>Remove</a></div>";
	...
	function removeAsteroid(id) {
		...
		var newStationInput = "<div class='new_station"+newStationNum+"'><input type='text' id='new_station"+ newStationNum +"' style='margin:10px;' value='Space Station "+newStationNum+"'><input type='text'id='stationXCoord_"+ newStationNum +"'style='margin:5px;' size='10' placeholder='X-Coordinate'><input type='text'id='stationYCoord_"+ newStationNum +"'style='margin:5px;'size='10' placeholder='Y-Coordinate'><a href='#' id='"+ newStationNum +"' onclick='saveStation(this.id)'>Save</a><a href='#' id='"+ newStationNum +"' onclick='removeStation(this.id)'>Remove</a></div>";
